...
const DownloadPage: React.FC = () => {
  const [activePlatform] = useState('all');
  ...
  // Platform stats removed - section commented out
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-5xl mx-auto">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-white mb-6 leading-tight">
              ...
              <span className="text-primary-400">All Your Devices</span>
            </h1>
                ...
                >
                  ...
                  <div className={`relative ${platform.bg} rounded-3xl overflow-hidden transition-all duration-500 group-hover:scale-105 group-hover:shadow-2xl h-full`}>
                    ...
                    <div className="relative p-6 h-full flex flex-col">
                      {/* Platform Header */}
                      <div className="flex justify-between items-start mb-6">
                        <div className="p-4 rounded-2xl bg-gradient-to-r from-primary-600 to-primary-700 shadow-lg">
                          <Icon className="h-8 w-8 text-white" />
                        </div>
                        <div className="bg-primary-100 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold text-primary-700">
                          {platform.platform}
                        </div>
                      </div>
                      ...
                      {/* Download Button */}
                      <button className="mt-auto w-full py-3 px-4 rounded-xl font-bold text-white transition-all duration-300 bg-gradient-to-r from-primary-600 to-primary-700 hover:shadow-lg hover:scale-105 flex items-center justify-center gap-2">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-primary-100 to-primary-200 text-primary-700 px-4 py-2 rounded-full text-sm font-bold mb-6">
                <SparklesIcon className="h-4 w-4" />
                WHY DOWNLOAD RINO?
              </div>
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                  ...
                  return (
                    <div key={index} className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-primary-600 font-medium">{feature.highlight}</div>
                      </div>
                    </div>
                  );
                })}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="bg-white rounded-2xl p-6 border border-gray-200">
                  <div className="bg-gradient-to-r from-primary-600 to-primary-700 rounded-xl p-3 inline-flex mb-4">
              ...
              return (
                <div key={index} className="relative group">
                  ...
                  {index < quickStartSteps.length - 1 && (
                    <div className="hidden md:block absolute top-12 left-3/4 w-full h-1 bg-gradient-to-r from-primary-500/20 to-transparent"></div>
                  )}
                  ...
                  <div className="relative bg-white rounded-3xl p-8 border border-gray-200 group-hover:shadow-2xl group-hover:scale-105 transition-all duration-500">
                    {/* Step Number */}
                    <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-r from-primary-600 to-primary-700 text-white rounded-2xl flex items-center justify-center text-xl font-bold shadow-lg">
                      {step.step}
                    </div>
                    
                    {/* Icon */}
                    <div className="p-4 rounded-2xl bg-gradient-to-r from-primary-600 to-primary-700 inline-flex mb-6">
                      <Icon className="h-8 w-8 text-white" />
                    </div>
                    ...
                    <div className="mt-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <a href="https://app.rino.co.tz" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm font-medium text-primary-600 hover:text-primary-700">
