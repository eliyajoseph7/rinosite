...
const SupportPage: React.FC = () => {
  ...
  const supportStats = [
    ...
    { value: '< 2min', label: 'Avg Chat Response', icon: ChatBubbleSolid, color: 'text-blue-600' },
    { value: '99%', label: 'Satisfaction Rate', icon: StarSolid, color: 'text-yellow-600' },
    { value: '500+', label: 'Help Articles', icon: BookOpenIcon, color: 'text-green-600' }
  ];
  ...
  const resources = [
    {
      ...
      description: '500+ step-by-step video guides for all features',
      count: '500+ videos',
      link: '#',
      color: 'from-purple-500 to-pink-500'
    },
    {
      ...
      description: 'Detailed user manuals and API documentation',
      count: '300+ articles',
      link: '#',
      color: 'from-blue-500 to-cyan-500'
    },
    {
      ...
      description: 'Connect with 10,000+ Rino users worldwide',
      count: '10K+ members',
      link: '#',
      color: 'from-green-500 to-emerald-500'
    },
    {
      ...
      title: 'Live Webinars',
      description: 'Weekly training sessions with product experts',
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-blue-50/20">
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden pt-24 pb-20">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-r from-purple-300/10 to-pink-300/10 rounded-full blur-3xl" style={{ animation: 'float 25s ease-in-out infinite reverse' }}></div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-5xl mx-auto">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-light leading-relaxed mb-12">
              Get the <span className="font-semibold text-blue-700">expert support</span> you need to maximize your success with Rino. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {supportChannels.map((channel, index) => {
              ...
              return (
                ...
                >
                  {/* Card Container */}
                  <div className={`relative ${channel.bg} rounded-3xl overflow-hidden transition-all duration-500 group-hover:scale-105 group-hover:shadow-2xl h-full`}>
                    {/* Border Glow */}
                    <div className={`absolute inset-0 rounded-3xl border-2 border-transparent group-hover:border-${channel.color.split('-')[1]}-500/30 transition-colors duration-300`}></div>
              ...
              <div className="sticky top-24">
                ...
                <div className="space-y-3 mb-8">
                  {quickLinks.map((link, idx) => {
                    ...
                    return (
                      <button
                        key={idx}
                        className="w-full flex items-center gap-4 p-4 bg-white rounded-xl border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all duration-300 group"
                      >
                ...
                <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-6 border border-blue-100">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      <PhoneSolid className="h-5 w-5 text-blue-600" />
                      <div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-medium text-gray-900">support@rino.app</div>
                    ...
                    <div className="bg-white rounded-2xl p-6 border border-gray-200 hover:border-blue-300 hover:shadow-xl transition-all duration-300">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <h4 className="text-lg font-semibold text-gray-900 mb-3 group-hover:text-blue-700 transition-colors">
                            {faq.question}
                          </h4>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-semibold text-gray-900 mb-1">+1 (555) 123-4567</p>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-semibold text-gray-900 mb-1">support@rino.app</p>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-2xl border border-gray-200">
              ...
              <form className="space-y-6">
                ...
                <button 
                  type="submit" 
                  className="w-full py-4 bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-bold rounded-xl hover:shadow-lg hover:scale-105 transition-all duration-300"
                >
                  Send Message
                </button>
              </form>
